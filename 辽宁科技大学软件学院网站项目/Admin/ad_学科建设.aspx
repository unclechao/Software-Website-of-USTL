<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Manage.Master" AutoEventWireup="true" CodeBehind="ad_学科建设.aspx.cs" Inherits="辽宁科技大学软件学院网站项目.Admin.ad_学科建设" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ObjectDataSource ID="odscourse" runat="server" DeleteMethod="Delete" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="学科建设" Name="Type" Type="String" />
        </SelectParameters>
        <InsertParameters>
            <asp:Parameter Name="Type" Type="String" />
            <asp:Parameter Name="Tittle" Type="String" />
        ...
        <a href="ad_学科建设edit.aspx?action=add">点击此处发布新闻</a>
    <asp:ListView ID="lvcourse" runat="server" DataKeyNames="Id" 
        ...
        <ItemTemplate>
            <tr >
                <td>
                    ...
                    <a href="ad_学科建设edit.aspx?action=edit&id=<%# Eval("Id") %>">编辑</a>
                </td>
                <td>
        ...
        <SelectedItemTemplate>
            <tr style="">
                ...
                <asp:DataPager ID="dpcourse" runat="server" PagedControlID="lvcourse">
        <Fields>
