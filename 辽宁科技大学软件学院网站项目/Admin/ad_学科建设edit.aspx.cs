...
{
    public partial class ad_学科建设edit : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else if (action == "edit")
                {
                    ...
                    lbsubject.SelectedValue= news.TypeSecond;
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            ...
            if (action == "add")
            {
                ...
                T_NewsTableAdapter adapter = new T_NewsTableAdapter();
                adapter.Insert("学科建设", txttittle.Text, txtcontent.Text, DateTime.Now, lbsubject.SelectedValue);
            }
            else if (action == "edit")
            {
                int id = Convert.ToInt32(Request["id"]);
