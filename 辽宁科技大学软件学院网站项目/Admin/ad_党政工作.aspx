<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Manage.Master" AutoEventWireup="true" CodeBehind="ad_党政工作.aspx.cs" Inherits="辽宁科技大学软件学院网站项目.Admin.ad_党政工作" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ObjectDataSource ID="odsparty" runat="server" DeleteMethod="Delete" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="党政工作" Name="Type" Type="String" />
        </SelectParameters>
        <InsertParameters>
            <asp:Parameter Name="Type" Type="String" />
            <asp:Parameter Name="Tittle" Type="String" />
        ...
        <a href="ad_党政工作edit.aspx?action=add">点击此处发布新闻</a>
    <asp:ListView ID="lvparty" runat="server" DataKeyNames="Id" 
        DataSourceID="odsparty">
        <ItemTemplate>
            <tr >
                <td>
                    <asp:Button ID="DeleteButton" runat="server" CommandName="Delete" Text="删除" OnClientClick='return confirm("确认删除？");'/>
                    <a href="ad_党政工作edit.aspx?action=edit&id=<%# Eval("Id") %>">编辑</a>
                </td>
                <td>
        ...
        <asp:DataPager ID="dpparty" runat="server" PagedControlID="lvparty">
        <Fields>
