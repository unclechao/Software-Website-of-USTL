...
{
    public partial class ad_通知公告edit : System.Web.UI.Page
    {
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            ...
            if (action == "add")
            {
                ...
                T_NewsTableAdapter adapter = new T_NewsTableAdapter();
                adapter.Insert("通知公告", txttittle.Text, txtcontent.Text, DateTime.Now, lbtxttypesecond.SelectedValue);
            }
            else if (action == "edit")
            {
                int id = Convert.ToInt32(Request["id"]);
            ...
            Response.Redirect("ad_通知公告.aspx");
        }
