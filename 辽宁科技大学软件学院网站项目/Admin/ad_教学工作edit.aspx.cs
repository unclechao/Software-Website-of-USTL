...
{
    public partial class ad_教学工作edit : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                else if (action == "edit")
                {
                    ...
                    lbteach.SelectedValue= news.TypeSecond;
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            ...
            if (action == "add")
            {
                ...
                T_NewsTableAdapter adapter = new T_NewsTableAdapter();
                adapter.Insert("教学工作", txttittle.Text, txtcontent.Text, DateTime.Now, lbteach.SelectedValue);
            }
            else if (action == "edit")
            {
                int id = Convert.ToInt32(Request["id"]);
