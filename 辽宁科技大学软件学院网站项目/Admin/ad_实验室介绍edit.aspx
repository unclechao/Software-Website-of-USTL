<%@ Page Title="" Language="C#"  ValidateRequest="false"  MasterPageFile="~/Admin/Manage.Master" AutoEventWireup="true" CodeBehind="ad_实验室介绍edit.aspx.cs" Inherits="辽宁科技大学软件学院网站项目.Admin.ad_实验室介绍edit" %>
...
新闻标题：<asp:TextBox ID="txttittle" runat="server"></asp:TextBox>
    ...
    <br />
二级分类：<asp:ListBox ID="lbtestroom" runat="server" Rows="1">
        <asp:ListItem>---请选择---</asp:ListItem>
        <asp:ListItem>实验室中心概况</asp:ListItem>
        <asp:ListItem>实验室开放</asp:ListItem>
        <asp:ListItem>实验室执行计划</asp:ListItem>
    </asp:ListBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
        ControlToValidate="lbtestroom" ErrorMessage="*" 
